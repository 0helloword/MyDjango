# Generated by Django 2.0.13 on 2019-06-19 07:20
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.CharField(db_index=True, max_length=256, verbose_name='栏目网站')),
                ('insto', models.TextField(default='', verbose_name='栏目简介')),
            ],
            options={
                'verbose_name': '栏目',
        ...
        migrations.AddField(
            model_name='article',
            name='column',
            field=models.ManyToManyField(to='news.Column', verbose_name='归宿栏目'),
        ),
    ]
